...
class BusHistoryData {
  ...
  factory BusHistoryData.fromJson(Map<String, dynamic> json) {
    return BusHistoryData(
        ...
        busNo: json['bus_no'],
        data: BusHistoryDataData.fromJson(json['data']));
  }
...
class BusHistoryDataData {
  ...
  factory BusHistoryDataData.fromJson(Map<String, dynamic> json) {
    return BusHistoryDataData(
...
class DataData {
  String? apiKey;
  List<Map<String, dynamic>>? vehicleActivityHistory;
  ...
  factory DataData.fromJson(Map<String, dynamic> json) {
    return DataData(
      ...
      vehicleActivityHistory: json['VEHICLE_ACTIVITY_HISTORY'] != null
          ? List<Map<String, dynamic>>.from(json['VEHICLE_ACTIVITY_HISTORY'])
          : null,
      ...
      vehicleTripHistory: json['VEHICLE_TRIP_HISTORY'] != null
          ? List<VehicleTripHistory>.from(
              json['VEHICLE_TRIP_HISTORY']
  ...
  Map<String, dynamic> toJson() {
    return {
      'api_key': apiKey,
      'VEHICLE_ACTIVITY_HISTORY': vehicleActivityHistory,
      'VEHICLE_DOCUMENTS_HISTORY': vehicleDocumentsHistory,
      'VEHICLE_JOB_HISTORY': vehicleJobHistory,
      'VEHICLE_CONTRACT_HISTORY':
          vehicleContractHistory?.map((x) => x.toJson()).toList(),
      'VEHICLE_TRIP_HISTORY':
          vehicleTripHistory?.map((x) => x.toJson()).toList(),
    };
  }
}
